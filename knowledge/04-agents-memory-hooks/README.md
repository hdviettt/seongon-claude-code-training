...
1. [`sub-agents.md`](sub-agents.md) — Tạo và dùng sub-agents.
2. [`memory.md`](memory.md) — CLAUDE.md, MEMORY.md, hệ thống phân cấp.
3. [`hooks.md`](hooks.md) — Hooks: trigger và action.

## Prerequisites

- Đã hiểu SKILLs (`knowledge/03-mo-rong-claude-code/skills-co-ban.md`).
